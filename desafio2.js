...
class Contenedor {
    ...
    async deleteById(idAEliminar){
        try {
            ...
            let contenidoNuevo = [...contenidoDeleteById];
        ...
        // const refresh = async ()=>{
        //     try {
        //         let contenidoNuevo = JSON.stringify(contenidoDeleteById, null, 2);
        //         await fs.promises.writeFile('./productos.txt', contenidoNuevo, 'utf-8');
        //     } catch (error) {
        //         console.log(error);
        //     }
        // } 
...
// contenedor.save({nombre: 'producto', precio: 100 });
// contenedor.getAll();
